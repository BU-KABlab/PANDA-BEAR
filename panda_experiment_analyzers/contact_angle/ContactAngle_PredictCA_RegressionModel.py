...
'''
python ContactAngle_PredictCA_RegressionModel.py `
  --model D:/1-PhD/4-RawData/2025/2025-07-08/models/contact_angle_poly_model_v2.pkl `
  batch `
  --in-csv D:/1-PhD/4-RawData/2025/pama_trainingdata/analysis/drying-and-trainingdata_output.csv `
  --out-csv D:/1-PhD/4-RawData/2025/pama_trainingdata/analysis/drying-and-trainingdata_output_with_theta.csv `

  
python -m ContactAngleScriptsForPANDAV2.ContactAngle_PredictCA_RegressionModel `
  --model "D:\1-PhD\4-RawData\2025\2025-07-08\models\contact_angle_poly_model_v2.pkl" `
  batch `
  --in-csv "D:\1-PhD\3-Research\Publications\PANDA-V2\ThesisData\ThesisData_distances.csv" `
  --out-csv "D:\1-PhD\3-Research\Publications\PANDA-V2\ThesisData\ThesisData_distances_with_theta.csv" `
  --train-csv-for-intervals "D:/1-PhD/4-RawData/2025/2025-07-08/2025-07-08_CAmodeldata.csv" `
  --interval-type prediction `
  --alpha 0.05 `
  --plots-dir "D:\1-PhD\3-Research\Publications\PANDA-V2\ThesisData\ThesisData_Distances_plots" `
  --id-column Image `
  --show-equation
