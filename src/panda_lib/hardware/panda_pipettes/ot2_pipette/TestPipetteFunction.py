...
def test_arduino_pipette():
    ...
    try:
        ...
        # Test aspirate
        print("\n=== Testing Aspirate ===")
        aspirate_response = arduino.send(
            PawduinoFunctions.CMD_PIPETTE_ASPIRATE, 100, 2500
        )
        ...
        # Test dispense
        print("\n=== Testing Dispense ===")
        dispense_response = arduino.send(
            PawduinoFunctions.CMD_PIPETTE_DISPENSE, 100, 2500
        )
