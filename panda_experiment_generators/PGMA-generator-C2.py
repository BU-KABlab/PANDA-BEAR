...
Author: Harley Quinn
Date: 2024-09-04
Description: For generation of PGMA-phenol experiments with 10 mm diameter wells, the second campaign of PGMA experiments.
...
params_df = pd.read_csv(
    r".\experiment_generators\PGMA_generator_C2.csv"
    ...
    for _, row in params_df.iterrows():
        ...
        experiments.append(
            experiment_class.PGMAExperiment(
                ...
                solutions={'PGMA-phenol': 320, 'DMF-TBAPrinse': 320, 'FC': 320, 'DMFrinse': 320, 'ACNrinse': 320},
                solutions_corrected={'PGMA-phenol': 0, 'DMF-TBAPrinse': 0, 'FC': 0, 'DMFrinse': 0, 'ACNrinse': 0},
