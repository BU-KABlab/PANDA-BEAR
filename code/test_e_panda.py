...
from e_panda import pipette_v2, solution_selector, waste_selector, NoAvailableSolution
...
class TestEPanda(unittest.TestCase):
    ...
    def test_pipette_v2(self):
        ...
        with self.subTest("Test pipetting from a well to a waste vial"):
            ...
            self.to_vessel = WasteVial(name="Test Waste Vial", position='W0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0)
            self.from_vessel.volume = 50.0
            self.to_vessel.volume = 50.0
            volume = 20.0
            pipette_v2(
        ...
        with self.subTest("Test pipetting from a stock vial to a waste vial"):
            self.from_vessel = StockVial(name="Test Stock Vial", position='S0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0)
            self.to_vessel = WasteVial(name="Test Waste Vial", position='W0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0)
            self.from_vessel.volume = 50.0
            self.to_vessel.volume = 50.0
            volume = 20.0
        ...
        with self.subTest("Test raising an error when pipetting from a well to a stock vial"):
            self.from_vessel = Well(well_id="T1", volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, height = 20, depth=10, status = "new")
            self.to_vessel = StockVial(name="Test Stock Vial", position='S0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0)
        ...
        with self.subTest("Test raising an error when pipetting from a waste vial to a well"):
            self.from_vessel = WasteVial(name="Test Waste Vial", position='W0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0)
        ...
        with self.subTest("Test raising an error when pipetting from a stock vial to a stock vial"):
            self.from_vessel = StockVial(name="Test Stock Vial 1", position='S0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0)
            self.to_vessel = StockVial(name="Test Stock Vial 2", position='S0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0)
            with self.assertRaises(ValueError):
                pipette_v2(
                    volume=20.0,
                    from_vessel=self.from_vessel,
    ...
    def test_solution_selector(self):
        ...
        solutions = [
            StockVial(name="Solution 1", position='S0', volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
            StockVial(name="Solution 2", position='S1',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
            StockVial(name="Solution 1", position='S2',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
        ]
        ...
        with self.subTest("Test selecting a solution from multiple options when one is empty"):
    ...
    def test_waste_selector(self):
        ...
        solutions = [
            WasteVial(name="Test Waste Vial 1", position='W0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
            WasteVial(name="Test Waste Vial 2", position='W1',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
            WasteVial(name="Test Waste Vial 1", position='W2',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
        ]
        ...
        with self.subTest("Test selecting a solution from multiple options when one is full"):
    ...
    def test_rinse_v2(self):
        ...
        from e_panda import rinse_v2
        # Test rinsing a well with rinse0, rinse1, and rinse2
        with self.subTest("Test rinsing a well with rinse0, rinse1, and rinse2"):
            wellplate = Wells2()
            stock_vials = [
                StockVial(name="rinse0", position='S0', volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
                StockVial(name="rinse1", position='S1', volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
                StockVial(name="rinse2", position='S2', volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0),
            ]
            waste_vials = [WasteVial(name="Test Waste Vial 1", position='W0',volume=50.0, capacity=100.0, density=1.0, coordinates={'x':0,'y':0,'z':0}, radius=5, height=10, z_bottom=0)]
            instructions = PEG_ACR_Instructions(id = 00, experiment_name= 'Rinse Test', priority= 1, target_well="A1", pin = 000, project_id = 0, solutions={}, rinse_count=3, rinse_vol=20.0)
            rinse_v2(
                wellplate=wellplate,
