...
def stopacq():
    ...
    np.savetxt('CA-WO3-Test2.txt', output)
    
    #plotdata
    df = pd.read_csv('CA-WO3-Test2.txt', sep=" ", header=None, names=["runtime", "Vf", "Vu","Im","Q","Vsig","Ach","IERange","Over","StopTest"])
