...
for i in range(3):
    experiments.append(
        experiment_class.EchemExperimentBase(
            ...
            solutions={'5mm_fecn6': 120, '10mm_fecn6': 0, 'electrolyte': 00},
            solutions_corrected={'5mm_fecn6': 120, '10mm_fecn6': 0, 'electrolyte': 0},
...
# Create 3 new experiments for the type 2 process
for i in range(3):
    experiments.append(
        experiment_class.EchemExperimentBase(
            id=experiment_id,
            ...
            project_id=PROJECT_ID,
            project_campaign_id=CAMPAIGN_ID,
            solutions={'5mm_fecn6': 0, '10mm_fecn6': 60, 'electrolyte': 60},
            solutions_corrected={'5mm_fecn6': 0, '10mm_fecn6': 60, 'electrolyte': 60},
            pumping_rate=PUMPING_RATE,
            status=experiment_class.ExperimentStatus.NEW,
            filename=EXPERIMENT_NAME + ' ' + str(experiment_id),
            process_type=2,
...
# Create 3 new experiments for the type 3 process
for i in range(3):
    experiments.append(
        experiment_class.EchemExperimentBase(
            id=experiment_id,
