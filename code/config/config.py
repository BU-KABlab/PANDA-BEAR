...
TESTING = False  # Set to True to run in testing mode -- THIS IS THE ONLY PLACE TO CHANGE THIS VALUE
...
if USE_LOCAL_PATHS:
    ...
    PATH_TO_EXPERIMENT_INBOX = LOCAL_REPO_PATH / __EXPERIMENT_INBOX
    PATH_TO_EXPERIMENT_QUEUE = LOCAL_REPO_PATH / __EXPERIMENT_QUEUE
    PATH_TO_COMPLETED_EXPERIMENTS = LOCAL_REPO_PATH / __EXPERIMENTS_COMPLETED
    PATH_TO_ERRORED_EXPERIMENTS = LOCAL_REPO_PATH / __EXPERIMENTS_ERROR
    PATH_TO_DATA = LOCAL_REPO_PATH / __DATA
    PATH_TO_LOGS = PATH_TO_CODE / __LOGS
    ...
    WELL_HX = PATH_TO_SYSTEM_STATE / __WELL_HISTORY
