...
experiment_H4 = Experiment(
    ...
    mix_rate=0.62,
    status=ExperimentStatus.NEW,
    filename="peg2p-test_H4",
    status_date=datetime.now(),
    results=None,
)
experiment_H5 = Experiment(
    id=9994030,
    priority=1,
    pin=CURRENT_PIN,
    target_well="H5",
    ...
    mix_rate=0.62,
    status=ExperimentStatus.NEW,
    filename="peg2p-test_H5",
    status_date=datetime.now(),
    results=None,
)
experiment_H6 = Experiment(
    id=9994031,
    priority=1,
    pin=CURRENT_PIN,
    target_well="H6",
    ...
    mix_rate=0.62,
    status=ExperimentStatus.NEW,
    filename="peg2p-test_H6",
    status_date=datetime.now(),
    results=None,
)
experiment_H8 = Experiment(
    id=9994033,
    priority=1,
    pin=CURRENT_PIN,
    target_well="H8",
    ...
    mix_rate=0.62,
    status=ExperimentStatus.NEW,
    filename="peg2p-test_H8",
    status_date=datetime.now(),
    results=None,
)
experiment_H9 = Experiment(
    id=9994034,
    priority=1,
    pin=CURRENT_PIN,
    target_well="H9",
    ...
    mix_rate=0.62,
    status=ExperimentStatus.NEW,
    filename="peg2p-test_H9",
    status_date=datetime.now(),
    results=None,
)
experiment_H7 = Experiment(
    id=9994032,
    priority=1,
    pin=CURRENT_PIN,
    target_well="H7",
