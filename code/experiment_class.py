...
class ExperimentResult:
    ...
    id: int = None
    well_id: str = None
    ocp_dep_files: list[Path] = None
    ocp_dep_passes: list[bool] = None
    ocp_char_files: list[Path] = None
    ocp_char_passes: list[bool] = None
    ocp_char_final_voltages: list[float] = None
    deposition_data_files: list[Path] = None
    deposition_plot_files: list[Path] = None
    deposition_max_values: list[float] = None
    depsotion_min_values: list[float] = None
    characterization_data_files: list[Path] = None
    characterization_plot_files: list[Path] = None
    characterization_max_values: list[float] = None
    characterization_min_values: list[float] = None
