...
-- Table: panda_mill_config
DROP TABLE IF EXISTS panda_mill_config;

CREATE TABLE IF NOT EXISTS panda_mill_config (
    id        INTEGER PRIMARY KEY AUTOINCREMENT,
    config    JSON,
    timestamp TEXT    DEFAULT CURRENT_TIMESTAMP
);

INSERT INTO panda_mill_config (id, config, timestamp) VALUES (1, '{
    "instrument_offsets": {
      "electrode": {
        "x": 34,
        "y": 35.5,
