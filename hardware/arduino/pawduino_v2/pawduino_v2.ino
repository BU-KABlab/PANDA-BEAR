...
Adafruit_NeoPixel dot_1(2, LEDR_2_PIN, NEO_GRB + NEO_KHZ800);
...
void lineBreakTest()
{
  ...
  { // Run for 10 cycles only
    ...
    { // Beam broken
      ...
      dot_1.setPixelColor(1, dot_1.Color(255, 0, 0)); // Second dot red
      dot_1.show();
    }
    else
    { // Beam unbroken
...
void loop()
{
  while (Serial.available() > 0)
  {
    ...
    case CMD_CONTACT_ON:
      ...
      dot_1.setPixelColor(1, dot_1.Color(255, 0, 0)); // Second dot (was LEDR_2)
      dot_1.show();
      ...
      sendResponse(RESP_CONTACT_ON,
                   verifyNeoPixelState(dot_1, 0, dot_1.Color(255, 0, 0)) &&
                       verifyNeoPixelState(dot_1, 1, dot_1.Color(255, 0, 0)));
      break;
    case CMD_CONTACT_OFF:
      ...
      sendResponse(RESP_CONTACT_OFF,
                   verifyNeoPixelState(dot_1, 0, 0) &&
                       verifyNeoPixelState(dot_1, 1, 0));
      break;
    case CMD_EMAG_ON:
